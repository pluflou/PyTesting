...
def test_transport_2():
     ...
     dt = 1
     assert (transport(loc, vel, dt) == np.array([[2, 3], [10, 11]])).all() #to check all elements of array
#
#
# # let's try one more, with dt that is float

###users can provide floats, integers, etc... how can we control this?
## cast it to a float in transport.py
